...
ok(/gwent:audio-hook/.test(feedbackSrc)&&/gwent:haptic-hook|navigator\.vibrate/.test(feedbackSrc),'audio and optional haptic routing exists');
...
ok(sw.includes("const BUILD='11.2D.0'"),'PWA cache must remain version-pinned and advance through Pass 11.2D');
